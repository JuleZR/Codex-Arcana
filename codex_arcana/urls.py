...
urlpatterns = [
    ...
    path("groups/<int:group_id>/creatures/add/", group_views.add_group_creature, name="add_group_creature"),
    path("groups/<int:group_id>/creatures/<int:creature_card_id>/delete/", group_views.delete_group_creature, name="delete_group_creature"),
    path("groups/<int:group_id>/creatures/<int:creature_card_id>/damage/", group_views.adjust_group_creature_damage, name="adjust_group_creature_damage"),
    path("groups/<int:group_id>/creatures/<int:creature_card_id>/kp/", group_views.adjust_group_creature_kp, name="adjust_group_creature_kp"),
    path(
        "groups/<int:group_id>/creatures/<int:creature_card_id>/vampirism/<slug:action>/",
        group_views.vampire_group_creature_action,
        name="vampire_group_creature_action",
    ),
    path("groups/<int:group_id>/creatures/<int:creature_card_id>/screen-state/", group_views.set_group_creature_screen_state, name="set_group_creature_screen_state"),
    path("groups/<int:group_id>/memberships/reorder/", group_views.reorder_group_memberships, name="reorder_group_memberships"),
    path("groups/<int:group_id>/memberships/<int:membership_id>/screen-state/", group_views.set_group_membership_screen_state, name="set_group_membership_screen_state"),
    path("groups/<int:group_id>/screen/inventory-state/", group_views.set_group_inventory_screen_state, name="set_group_inventory_screen_state"),
    path("groups/<int:group_id>/notes/update/", group_views.update_group_note, name="update_group_note"),
    path("groups/<int:group_id>/notes/show/", group_views.show_group_note, name="show_group_note"),
    path("groups/<int:group_id>/notes/hide/", group_views.hide_group_note, name="hide_group_note"),
    ...
    path("groups/<int:group_id>/tables/<int:table_id>/columns/<int:column_id>/delete/", group_views.delete_group_table_column, name="delete_group_table_column"),
    path("groups/<int:group_id>/tables/<int:table_id>/delete/", group_views.delete_group_table, name="delete_group_table"),
    path("groups/<int:group_id>/tables/<int:table_id>/show/", group_views.show_group_table, name="show_group_table"),
    path("groups/<int:group_id>/tables/<int:table_id>/hide/", group_views.hide_group_table, name="hide_group_table"),
    ...
    path("groups/<int:group_id>/inventory/<int:character_item_id>/disclosure/", group_views.update_group_item_disclosure, name="update_group_item_disclosure"),
    path("groups/<int:group_id>/inventory/<int:character_item_id>/effect-identification/", group_views.update_group_item_effect_identification, name="update_group_item_effect_identification"),
    path("groups/<int:group_id>/inventory/<int:character_item_id>/reveal-all/", group_views.reveal_group_item, name="reveal_group_item"),
    path("groups/<int:group_id>/inventory/<int:character_item_id>/hide-all/", group_views.hide_group_item, name="hide_group_item"),
    path("groups/<int:group_id>/inventory/<int:item_id>/send/", group_views.send_group_inventory_item, name="send_group_inventory_item"),
    path("groups/<int:group_id>/inventory/send/", group_views.send_group_inventory_items, name="send_group_inventory_items"),
    ...
    path("groups/<int:group_id>/inventory/delete/", group_views.delete_group_inventory_items, name="delete_group_inventory_items"),
    ...
    path("dashboard/account/logout-other-sessions/", views.logout_other_sessions, name="logout_other_sessions"),
    path("dashboard/account/export/", views.export_account_data, name="export_account_data"),
    ...
    path("character/<int:character_id>/temporary-attributes/", views.update_temporary_attribute, name="update_temporary_attribute"),
